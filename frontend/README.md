...
## Quick start (it is quick... if you've got installed environment alredy)
### Dobra teraz po polsku co trzeba zrobić żeby cokolwiek zabanglało.
>Zainstaluj Node.js https://nodejs.org/en/

>Sprawdź czy działa. W konsoli "node -v"

>Pobierz WebStroma/IntelliJ Ultimeate

>Zaimportuj projekt

>Odpal konsolkę z poziomu w którym znajduje się projekt

>\> npm install - zainstaluje wszsytkie moduły nodejs potrzebne do budowania projektu, npm to taki maven dla JSa

>\> npm run dev - zbuduje projekt i go postawi. Zapraszam na localhost:8080
